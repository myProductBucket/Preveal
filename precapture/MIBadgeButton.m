...
- (void) setupBadgeViewWithString:(NSString *)string
{
    ...
    [badgeLabel setFrame:CGRectMake(self.bounds.size.width - 15 + horizontal, -(badgeSize.height / 2) - 10 + vertical, badgeSize.width,  badgeSize.width > 25 ? badgeSize.height : badgeSize.width)];
    [self setupBadgeStyle];
